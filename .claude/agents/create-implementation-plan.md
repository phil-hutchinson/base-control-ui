...
- **Record the design reasoning here.** The code does not carry its own design
  history in this repository, so the plan is the only place decisions and
  rejected alternatives are written down. Be explicit and complete.
