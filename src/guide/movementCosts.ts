...
/**
 * A square at least two files and two ranks from every edge, so
 ...
 * neighbours at 0, the four diagonal neighbours at 1, and the twelve
 * two-step squares — four straight, eight L-shaped — at 2. The four (±2, ±2)
 * corners are not reachable in one move and are absent, and so is the centre
 * itself. If two shapes were ever to reach the same offset, the cheaper is
 * kept.
 */
