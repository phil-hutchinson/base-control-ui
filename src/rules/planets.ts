// The fourteen planet squares (rules.md §3.1).

import { type Square, squareAt, squareName } from "./board";

/** The fourteen planet squares, in the order rules.md §3.1 lists them. */
...
/** Whether a square is one of the fourteen planets. */
